...
{
    return proc_create_data("joystick_kbd", S_IRUGO, NULL, &proc_ops, usb_joystick_kbd);
}
...
ssize_t proc_read(struct file *file, char __user *buff, size_t size, loff_t *offset)
{
